...
class Flexy_Breadcrumb_Trail {
        ...
        if ($post->post_parent) {
            ...
            if ($ancestors) {
                ...
                foreach ($ancestors as $ancestor) {
                    echo'<li itemprop="itemListElement" itemscope itemtype="' . esc_url("https://schema.org/ListItem") . '"><a itemprop="item" page-parent="' . esc_attr($ancestor) . '" href="' . esc_url(get_permalink($ancestor)) . '" title="' . esc_attr(get_the_title($ancestor)) . '"><span itemprop="name">' . $this->fbc_limit_strings(esc_attr(get_the_title($ancestor)), $fbc_limit_style, $fbc_text_limit, $fbc_end_text) . '</span></a><meta itemprop="position" content="' . $counter . '" /></li>' . $separator_template . '';
                    $counter++;
                }
                if (get_query_var('paged') > 1 || get_query_var('page') > 1) {
                    // Current page
                    echo'<li itemprop="itemListElement" itemscope itemtype="' . esc_url("https://schema.org/ListItem") . '"><span itemprop="name">' . $this->fbc_limit_strings(esc_attr(get_the_title()), $fbc_limit_style, $fbc_text_limit, $fbc_end_text) . '</span><meta itemprop="position" content="' . $counter . '" /></li>';
                    $this->fbc_pagination_trail();
                } else {

                    // Current page
                    echo'<li class="active post-page" itemprop="itemListElement" itemscope itemtype="' . esc_url("https://schema.org/ListItem") . '"><span itemprop="name" title="' . esc_attr(get_the_title()) . '">' . $this->fbc_limit_strings(esc_attr(get_the_title()), $fbc_limit_style = 'word', $fbc_text_limit, $fbc_end_text) . '</span><meta itemprop="position" content="' . $counter . '" /></li>';
                }
            }
        } else {
            if (get_query_var('paged') > 1 || get_query_var('page') > 1) {
                ...
                // Current page
                echo'<li itemprop="itemListElement" itemscope itemtype="' . esc_url("https://schema.org/ListItem") . '"><span itemprop="name">' . $this->fbc_limit_strings(esc_attr(get_the_title()), $fbc_limit_style = 'word', $fbc_text_limit, $fbc_end_text) . '</span><meta itemprop="position" content="' . $counter . '" /></li>';
                $this->fbc_pagination_trail();
            } else {
                echo'<li class="active" itemprop="itemListElement" itemscope itemtype="' . esc_url("https://schema.org/ListItem") . '"><span itemprop="name" title="' . esc_attr(get_the_title()) . '">' . $this->fbc_limit_strings(esc_attr(get_the_title()), $fbc_limit_style = 'word', $fbc_text_limit, $fbc_end_text) . '</span><meta itemprop="position" content="' . $counter . '" /></li>';
            }
        }
    }
    ...
    public function fbc_post_archive_trail() {
        ...
        if($post_type==='post'){
            ...
            $blog_url=get_the_guid(get_option('page_for_posts', true));
            if(isset($page_post_title)){
                // Current Page
                $post_id =  get_option( 'page_for_posts' );
                if($post_id){
                    echo '<li itemprop="itemListElement" itemscope itemtype="' . esc_url("https://schema.org/ListItem") . '"><a itemprop="item" href="' . esc_url($blog_url) . '" title="' . esc_attr(get_the_title()) . '" ><span itemprop="name">'. $this->fbc_limit_strings(esc_attr($page_post_title), $fbc_limit_style, $fbc_text_limit, $fbc_end_text).'</span></a><meta itemprop="position" content="2" /></li>';
                    echo  $separator_template;
                }
            }
        }
    ...
    public function fbc_post_detail_trail() {
        ...
        if(isset($page_post_title)){
            ...
            if ($post_type != 'post') {
                ...
                echo'<li class="active" itemprop="itemListElement" itemscope itemtype="' . esc_url("https://schema.org/ListItem") . '"><span itemprop="name" title="' . esc_attr(get_the_title()) . '">' . $this->fbc_limit_strings(esc_attr(get_the_title()), $fbc_limit_style, $fbc_text_limit, $fbc_end_text) . '</span><meta itemprop="position" content="' . $counter++ . '" /></li>';
            }
            // For WP post
    ...
    public function fbc_category_trail() {
        ...
        if (get_query_var('paged') > 1 || get_query_var('page') > 1) {
            ...
            // Current Page
            echo '<li itemprop="itemListElement" itemscope itemtype="' . esc_url("https://schema.org/ListItem") . '"><span itemprop="name">' . $this->fbc_limit_strings(esc_attr($cat->name), $fbc_limit_style, $fbc_text_limit, $fbc_end_text) . '</span><meta itemprop="position" content="' . $counter++ . '" /></li>';
            $this->fbc_pagination_trail();
        } else {

            // Current Page
            echo '<li class="active" itemprop="itemListElement" itemscope itemtype="' . esc_url("https://schema.org/ListItem") . '"><span itemprop="name" title="' . esc_attr($cat->name) . '">' . $this->fbc_limit_strings(esc_attr($cat->name), $fbc_limit_style, $fbc_text_limit, $fbc_end_text) . '</span><meta itemprop="position" content="' . $counter++ . '" /></li>';
        }
    }
    ...
    public function fbc_tag_trail() {
        ...
        if (get_query_var('paged') > 1 || get_query_var('page') > 1) {
            ...
            echo '<li class="item-current item-tag-' . $get_term_id . '"><span itemprop="name">' . $this->fbc_limit_strings(esc_attr($get_term_name), $fbc_limit_style, $fbc_text_limit, $fbc_end_text) . '</span><meta itemprop="position" content="' . $counter++ . '" /></li>';
            $this->fbc_pagination_trail();
        } else {

            // Display the tag name
            echo '<li class="active item-current item-tag-' . $get_term_id . '"><span itemprop="name" title="' . esc_attr($get_term_name) . '">' . $this->fbc_limit_strings(esc_attr($get_term_name), $fbc_limit_style, $fbc_text_limit, $fbc_end_text) . '</span><meta itemprop="position" content="' . $counter++ . '" /></li>';
        }
    }
    ...
    public function fbc_day_archive_trail() {
        ...
        if (get_query_var('paged') > 1 || get_query_var('page') > 1) {
            // Day
            echo '<li itemprop="itemListElement" itemscope itemtype="' . esc_url("https://schema.org/ListItem") . '" class="item-' . esc_attr(get_the_time('j')) . '"><span itemprop="name">' . esc_attr(get_the_time('j')) . '</span><meta itemprop="position" content="' . $counter++ . '" /></li>';
            $this->fbc_pagination_trail();
        } else {
            echo '<li itemprop="itemListElement" itemscope itemtype="' . esc_url("https://schema.org/ListItem") . '" class="active item-current item-' . esc_attr(get_the_time('j')) . '"><span itemprop="name">' . esc_attr(get_the_time('j')) . '</span><meta itemprop="position" content="' . $counter++ . '" /></li>';
        }
    }
    ...
    public function fbc_search_page_trail() {
        ...
        if (get_query_var('paged') > 1 || get_query_var('page') > 1) {
            ...
            // Search results page
            echo '<li itemprop="itemListElement" itemscope itemtype="' . esc_url("https://schema.org/ListItem") . '" class="item-current-' . esc_attr(get_search_query()) . '"><span itemprop="name"><strong>' . __('Search: ', 'flexy-breadcrumb') . '</strong>' . $this->fbc_limit_strings(esc_attr(get_search_query()), $fbc_limit_style, $fbc_text_limit, $fbc_end_text) . '</span><meta itemprop="position" content="2"></li>';
            $this->fbc_pagination_trail();
        } else {
            echo '<li itemprop="itemListElement" itemscope itemtype="' . esc_url("https://schema.org/ListItem") . '" class="active item-current-' . esc_attr(get_search_query()) . '"><span itemprop="name"><strong>' . __('Search: ', 'flexy-breadcrumb') . '</strong>' . $this->fbc_limit_strings(esc_attr(get_search_query()), $fbc_limit_style, $fbc_text_limit, $fbc_end_text) . '</span><meta itemprop="position" content="2"></li>';
        }
    }
