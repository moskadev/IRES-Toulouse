    ...
    <div class="wrap">
		...
		if ( current_user_can( 'create_users' ) ) {
            ...
            >
				...
				$new_user_send_notification = $creating;
                ...
                <table class="form-table" role="presentation">
                    <tr class="form-field form-required">
                        ...
                        <td><input name="user_login" type="text" id="user_login" autocomplete="off" value="<?php echo esc_attr( $new_user_login ); ?>" aria-required="true" autocapitalize="none" autocorrect="off" maxlength="60" /></td>
                    </tr>
                    <tr class="form-field form-required">
					...
					<?php if ( current_user_can( 'promote_users' ) ) { ?>
                        <tr class="form">
                            <th scope="row"><label for="role">Rôle responsable</label></th>
                    ...
                    echo "Mot de passe généré aléatoirement : ".$initial_password; ?>
                    <td style="opacity: 0">
                        <input style="width: 0px; height: 0px" type="password" name="pass1" id="pass1" class="regular-text" autocomplete="off" data-reveal="1" data-pw="<?php echo esc_attr( $initial_password ); ?>" aria-describedby="pass-strength-result" /><input type="hidden" name="pass2" id="pass2" data-pw="<?php echo esc_attr( $initial_password ); ?>">
                        <input style="width: 0px; height: 0px" name="pass2" type="password" id="pass2" autocomplete="" aria-describedby="pass2-desc" value="<?php echo esc_attr( $initial_password ); ?>" />
                    </td>
                </table>
